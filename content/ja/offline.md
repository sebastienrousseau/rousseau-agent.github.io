...
layout: "page"
permalink: "https://docs.rousseau-agent.dev/ja/offline/"
subtitle: "オフラインです。"
tags: "system, offline"
title: "オフライン"
...
このドキュメントページはキャッシュされており、ネットワークがなくても閲覧できます。サイトの残りの部分は、再接続でき次第すぐに戻ります。

`rousseau-agent` はセルフホストされているため、デーモン自体は LLM プロバイダとアクティブなチャットトランスポートに到達するためのネットワークのみを必要とします。ループの残り (エージェント、ツール、セッションストア) は完全にオフラインで動作します。
