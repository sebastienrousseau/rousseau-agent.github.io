...
layout: "page"
permalink: "https://docs.rousseau-agent.dev/pt-BR/offline/"
subtitle: "Você está offline."
tags: "system, offline"
title: "Offline"
...
Esta página de documentação está em cache e legível sem rede. O resto do site voltará assim que você reconectar.

Como o `rousseau-agent` é auto-hospedado, o daemon em si só precisa de rede para alcançar seu provedor LLM e qualquer transporte de chat ativo — o resto do loop (agente, ferramentas, armazenamento de sessões) funciona totalmente offline.
